    ...
    <?php echo $__env->make('block.title', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <input class="form-control" id="adminnickname" placeholder="管理者ニックネーム" type="text" name="adminnickname" value="<?php echo e($nickname); ?>">
            </div> 
        </div> 
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <input class="form-control" id="adminloginid" placeholder="管理者ログインID" type="text" name="adminloginid" value="<?php echo e($loginid); ?>" readonly>
            </div> 
        </div> 
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <input class="form-control" id="adminemail" placeholder="管理者Eメールアドレス" type="text" name="adminemail" value="<?php echo e($email); ?>">
            </div> 
        </div> 
...
</script><?php /**PATH /Users/shiraishitoshio/Laravel/Laravel_mysite_new2/resources/views/admin/adminaccount.blade.php ENDPATH**/ ?>