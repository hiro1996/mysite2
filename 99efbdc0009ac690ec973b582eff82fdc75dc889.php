    ...
    <?php echo $__env->make('block.title', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <input class="form-control <?php if($errors->has('email')): ?> is-invalid <?php endif; ?>" placeholder="メールアドレス" id="email" data-whatever="<?php echo e(old('email')); ?>" name="email" value="<?php echo e(old('email')); ?>" required>
...
</script><?php /**PATH /Users/shiraishitoshio/Laravel/Laravel_mysite_new2/resources/views/admin/adminlink.blade.php ENDPATH**/ ?>